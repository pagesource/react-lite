...
declare module 'normalizr' {
  ...
  declare export function normalize<Result, Collections>(
    raw: $ReadOnlyArray<mixed> | Object,
    schema: Schema
  ): NormalizeResult<Result, Collections>;
  declare export function denormalize(input: mixed, schema: Schema, entities: mixed): any;
}
